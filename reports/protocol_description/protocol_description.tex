...
\begin{description}
	\item[\textbf{\textit{a priori:}}] Each node enters the network aware of the
		hash function generator (HFG) $\mathcal{H}$, the threshold parameter
		$\tau$, and the null parent node $\varnothing$.
\end{description}
